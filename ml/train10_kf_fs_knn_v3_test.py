...
def train_knn(train_set, test_set, k, algo, wgt):
    ...
    knnclf = knn(n_neighbors=k, algorithm=algo, n_jobs=2 , weights=wgt)
...
def kfoldcrossval(df, k):
    ...
    for i in range(1):
        ...
        for train_i, test_i in kf.split(df):
            ...
            res = train_knn(train, test, k, 'ball_tree', 'distance')
...
if __name__ == "__main__":
    ...
    """ FEATURES 10 moves - n_neigh = 4"""
    feature_list = [
    'mean_ax0', 'mean_az0', 'mean_ax1', 'mean_az1', 'mean_gx1',
    'mean_gy1', 'mean_abs_ax0', 'mean_abs_az0', 'mean_abs_ax1',
    'mean_abs_ay1', 'mean_abs_az1', 'mean_abs_gx1', 'mean_abs_gy1',
    'std_ax0', 'std_ay0', 'std_az0', 'std_ax1', 'std_ay1', 'std_az1',
    'std_gx0', 'std_gy0', 'std_gx1', 'std_gy1', 'median_ax0',
    'median_az0', 'median_ax1', 'median_az1', 'median_gy1', 'mad_ax0',
    'mad_ay0', 'mad_az0', 'mad_ax1', 'mad_ay1', 'mad_az1', 'mad_gx0',
    'mad_gy0', 'mad_gx1', 'mad_gy1', 'max_ax0', 'max_az0', 'max_ax1',
    'max_ay1', 'max_az1', 'max_gx0', 'max_gy0', 'max_gy1', 'min_ax0',
    'min_ay0', 'min_az0', 'min_ax1', 'min_az1', 'min_gx0', 'min_gy0',
    'min_gx1', 'min_gy1', 'range_ay0', 'range_az0', 'range_ax1',
    'range_ay1', 'range_az1', 'range_gx0', 'range_gy0', 'range_gx1',
    'range_gy1', 'corr_axz0', 'corr_ayz0', 'corr_axz1', 'corr_gxy0',
    'corr_gxy1', 'corr_ax1x0', 'corr_ay1x0', 'corr_ay1y0', 'corr_ay1z0',
    ...
    res['scores'] = scores
    res['n_neighbors'] = n_neigh
    res.to_csv('result-training.csv', index=False)
    f, ax = plt.subplots( 1 )
    sns.pointplot(
        x="n_neighbors",
        y="scores",
